...
struct _Unwind_Context
{
    ...
    _Unwind_Context(register_state *s, _Unwind_Exception *eo) : state(s),
                                                                exception_object(eo)
    {
    }
};

static _Unwind_Reason_Code private_personality(_Unwind_Action action, _Unwind_Context *context)
{
...
static _Unwind_Reason_Code find_and_store_fde(_Unwind_Context *context)
{
...
static _Unwind_Reason_Code private_phase1(_Unwind_Context *context)
{
...
static _Unwind_Reason_Code private_phase2(_Unwind_Context *context)
{
    auto result = _URC_CONTINUE_UNWIND;
