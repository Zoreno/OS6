...
static void sha512_secure_wipe(void *v, uint64_t n)
{
...
static void sha512_start(sha512_context_t *ctx)
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
...
#define P(a, b, c, d, e, f, g, h, x, K, i)       \
    {                                            \
...
static void sha512_process(sha512_context_t *ctx, const unsigned char data[128])
{
    int i;
...
static void sha512_update(sha512_context_t *ctx, const unsigned char *input, size_t ilen)
{
    size_t fill;
    unsigned int left;
...
static void sha512_finish(sha512_context_t *ctx, unsigned char *output)
{
    size_t last;
    size_t padn;
    uint64_t high;
...
void sha512(const uint8_t *in, size_t n, uint8_t *out)
{
    ...
    sha512_secure_wipe(&ctx, sizeof(sha512_context_t));
}